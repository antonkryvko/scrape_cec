...
It's a try to make a module for scraping territorial communities candidates' information
...
START_COMMUNITIES_URL = 'https://www.cvk.gov.ua/pls/vm2020/pvm158pt001f01=695.html'
CURRENT_ELECTION_URL = 'https://www.cvk.gov.ua/pls/vm2020/'
PATH_TO_LOCATION = '2020/local'
OUTPUT_FILENAME = '2020/local/communities.csv'

CANDIDATE_DISTRICT = 'Номер округу'
CANDIDATE_NAME = 'ПІБ'
...
SELECT_CANDIDATE_DISTRICT = 'table:nth-of-type(3) td.td2:nth-of-type(1), table:nth-of-type(3) td.td3:nth-of-type(1)'
SELECT_CANDIDATE_NAME = 'table:nth-of-type(3) td.td2:nth-of-type(2), table:nth-of-type(3) td.td3:nth-of-type(2)'
SELECT_CANDIDATE_BIRTHDAY = 'table:nth-of-type(3) td.td2:nth-of-type(3), table:nth-of-type(3) td.td3:nth-of-type(3)'
SELECT_CANDIDATE_PARTY = 'table:nth-of-type(3) td.td2:nth-of-type(4), table:nth-of-type(3) td.td3:nth-of-type(4)'
SELECT_CANDIDATE_INFO = 'table:nth-of-type(3) td.td2:nth-of-type(5), table:nth-of-type(3) td.td3:nth-of-type(5)'
SELECT_CANDIDATE_REGISTRATION_DATE = 'table:nth-of-type(3) td.td2:nth-of-type(6), table:nth-of-type(3) td.td3:nth-of-type(6)'
SELECT_CANDIDATE_COUNCIL = 'p.p2'


def get_all_urls():
    start_time = time()
    response = requests.get(START_COMMUNITIES_URL, verify=False)
